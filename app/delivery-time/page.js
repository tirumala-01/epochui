...
import { Bug, MapPinHouse, Clock3 } from 'lucide-react';
...
export default function Page() {
    ...
    let { fetchTimeData, city_data, city_data_loading, resetCityStore, city_data_error } = useCitiesStore();
                                    ...
                                    <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
                                        <Card className="w-full sm:w-[350px]">
                                            <CardHeader>
                                                ...
                                                <CardDescription>Check shipment time details.</CardDescription>
                                            </CardHeader>
                                            ...
                                            <CardFooter className="flex justify-between">
                                                ...
                                                <Button type="submit" disabled={city_data_loading}>
                                                    {city_data_loading ? "Loading..." : "Submit"}
                                                </Button>
                                            </CardFooter>
                                        </Card>
                                    </form>
